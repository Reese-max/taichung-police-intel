...
驗證：`tests/test_public_event_fusion.py` 15 tests pass；`node --test apps/web/tests/public-event-fusion.test.mjs` 2 tests pass；CLI self-check 會重播三來源、版本衝突、entity registry receipt 與背景資料防護。
