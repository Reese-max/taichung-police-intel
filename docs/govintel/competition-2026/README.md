...
本分支增加前端快照年齡判斷、發布階段留證與測試，**尚未合併／部署**。它不代表 #20 已修復，亦未實作全文抽取、事件融合、跨日追蹤或 Twinkle client。
...
| main 分支保護導致推送阻塞 | **仍未修復**，本輪不改保護／token／資料持久化路徑 | #20；[後續修復邊界](PUBLICATION_RECOVERY.md) |
