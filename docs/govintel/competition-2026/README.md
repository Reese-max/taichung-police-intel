...
| 受限 Query Gateway（Web／HTTP MCP／STDIO MCP；domain store adapters） | `IMPLEMENTED_NOT_PRODUCTION` | #29/#30 typed adapters、#47 current-checkout `24/24` receipt；正式 PublicEvent/statistics store 尚未接入 |
